...
class BuildingTest {
    ...
    @Test
    void testEqualsFailBikeRental() {
        Building failBuilding = new Building("EWI", "0900", "2100", "Faculty of Electrical Engineering, Mathematics and Computer Science", 10);
        assertNotEquals(building, failBuilding);
    }
    ...
    @Test
    void testToString() {
        assertEquals(testString, building.toString());
    }

    @Test
    void testRentBike() {
        building.rentBike(30);
        assertEquals(45, building.getBikeRental());
    }

    @Test
    void testReturnBike() {
        building.rentBike(-45);
        assertEquals(120, building.getBikeRental());
    }
